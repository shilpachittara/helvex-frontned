...
import {
  ...
  hashIntentPayload,
  toCanonicalPayload,
} from "./intent-signing.js";

const input = {
  intentId: "intent-1",
  maker: "maker::1",
  pair: "CBTC_USDCX" as const,
  sellAmount: "0.01",
  minBuyAmount: "10",
...
test("canonical string pins the field order", () => {
  ...
  assert.equal(
    s,
    '{"domain":"intent-swap/v1","intentId":"intent-1","maker":"maker::1","pair":"CBTC_USDCX","sellAmount":"0.01","minBuyAmount":"10","deadline":"2030-01-01T00:00:00.000Z","nonce":42}',
  );
});
