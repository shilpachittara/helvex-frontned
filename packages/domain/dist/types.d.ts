export declare const INTENT_SIGN_DOMAIN = "intent-swap/v1";
export declare const INTENT_STATUSES: readonly ["DRAFT", "SUBMITTED", "LOCK_PENDING", "LOCKED", "MATCHED", "SETTLING", "SETTLED", "EXPIRED", "REFUNDING", "REFUNDED", "CANCELLED", "FAILED"];
export type IntentStatus = (typeof INTENT_STATUSES)[number];
export declare const PAIR_IDS: readonly ["CBTC_USDCX", "USDCX_CBTC", "CC_USDCX", "USDCX_CC", "CC_CC"];
...
export declare const PROFILE_TYPES: readonly ["INDIVIDUAL", "INSTITUTION", "MARKET_MAKER", "LIQUIDITY_PROVIDER"];
export type ProfileType = (typeof PROFILE_TYPES)[number];
export declare const ACCOUNT_STATUSES: readonly ["ACTIVE", "FROZEN", "CLOSED"];
export type AccountStatus = (typeof ACCOUNT_STATUSES)[number];
export declare const DEPOSIT_STATUSES: readonly ["PENDING", "CONFIRMED", "CREDITED", "FAILED"];
export type DepositStatus = (typeof DEPOSIT_STATUSES)[number];
export declare const WITHDRAWAL_STATUSES: readonly ["REQUESTED", "APPROVED", "SUBMITTED", "COMPLETED", "REJECTED", "FAILED"];
export type WithdrawalStatus = (typeof WITHDRAWAL_STATUSES)[number];
export declare const TRANSFER_STATUSES: readonly ["PENDING", "COMPLETED", "FAILED"];
export type TransferStatus = (typeof TRANSFER_STATUSES)[number];
/** API-key capability scopes. */
export declare const API_KEY_SCOPES: readonly ["read", "maker", "solver", "withdraw", "transfer"];
