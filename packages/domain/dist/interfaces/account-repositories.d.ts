import type { AccountStatus, ApiKeyRecord, ApiKeyScope, AuditLogEntry, DepositRecord, DepositStatus, ProfileType, TradingAccount, TransferRecord, TransferStatus, WithdrawalRecord, WithdrawalStatus } from "../types.js";
...
export interface WithdrawalRepository {
    ...
    setStatus(id: string, status: WithdrawalStatus, extra?: {
        ledgerTxId?: string;
        approvedBy?: string;
     ...
     */
    setStatusIfCurrent(id: string, from: WithdrawalStatus, to: WithdrawalStatus): Promise<boolean>;
}
...
export interface TransferRepository {
    ...
    setStatus(id: string, status: TransferStatus, extra?: {
        ledgerTxId?: string;
        failureReason?: string;
    }): Promise<void>;
}
