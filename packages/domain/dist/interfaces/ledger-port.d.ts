import type { AppFeeConfig, IntentRecord, LockResult, RefundResult, SettleResult } from "../types.js";
...
export interface LedgerPort {
    ...
    settleIntent(intent: IntentRecord, solver: string, buyAmount: string, commandId: string, fee?: AppFeeConfig): Promise<SettleResult>;
     ...
     */
    consolidateHoldings?(party: string, instrumentId: string, commandId: string): Promise<ConsolidateResult>;
}
//# sourceMappingURL=ledger-port.d.ts.map